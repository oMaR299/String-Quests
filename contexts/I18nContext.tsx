...
const translations: Record<'ar' | 'en', Record<string, string>> = {
  ar: {
    ...
    'phoneAppOnboarding.brand.headline': 'أهلاً بك في String',
    'phoneAppOnboarding.brand.subhead': 'نتعلم معاً، خطوة بخطوة',
    'phoneAppOnboarding.brand.cta': 'ابدأ',
    'phoneAppOnboarding.role.headline': 'من أنت؟',
    'phoneAppOnboarding.role.subhead': 'اختر دورك لنخصص لك التجربة',
    'phoneAppOnboarding.role.parent.title': 'ولي أمر',
    'phoneAppOnboarding.role.parent.sub': 'أتابع رحلة طفلي',
    'phoneAppOnboarding.role.student.title': 'طالب',
    'phoneAppOnboarding.role.student.sub': 'أتعلم وأتطور',
    'phoneAppOnboarding.role.teacher.title': 'معلم',
    'phoneAppOnboarding.role.teacher.sub': 'أرافق طلابي',
    'phoneAppOnboarding.role.soon': 'قريباً',
    'phoneAppOnboarding.pain.headline': 'ما الذي يهمك أكثر؟',
    'phoneAppOnboarding.pain.subhead': 'اختر كل ما ينطبق عليك',
    'phoneAppOnboarding.pain.cta': 'متابعة',
    'phoneAppOnboarding.biggest.headline': 'ما الأكثر إزعاجاً لك؟',
    'phoneAppOnboarding.biggest.subhead': 'سنبدأ بحل هذه أولاً',
    'phoneAppOnboarding.biggest.cta': 'هذه هي',
    'phoneAppOnboarding.aha.headline': 'ملخص أسبوعي يصلك كل أحد',
    'phoneAppOnboarding.aha.subhead': 'كل ما تحتاج معرفته عن رحلة طفلك في 60 ثانية',
    'phoneAppOnboarding.aha.banner.title': 'String — الملخص الأسبوعي',
    'phoneAppOnboarding.aha.banner.body': 'الأحد ٧:٠٠ مساءً — ملخص هذا الأسبوع لطفلك جاهز',
    'phoneAppOnboarding.aha.topicLabel': 'موضوع للسؤال عنه',
    'phoneAppOnboarding.aha.winLabel': 'إنجاز للاحتفال به',
    'phoneAppOnboarding.aha.cta': 'متابعة (قريباً)',
    'phoneAppOnboarding.aha.toast': 'بقية الخطوات قادمة قريباً',
    'phoneAppOnboarding.back': 'رجوع',
    'phoneAppOnboarding.mute.on': 'إلغاء كتم الصوت',
    'phoneAppOnboarding.mute.off': 'كتم الصوت',
  },
  en: {
    // Navigation
    'nav.home': 'Home',
    ...
    // ── Phone App onboarding ──────────────────────────────
    'phoneAppOnboarding.brand.headline': 'Welcome to String',
    'phoneAppOnboarding.brand.subhead': 'We learn together, step by step',
    'phoneAppOnboarding.brand.cta': 'Start',
    'phoneAppOnboarding.role.headline': 'Who are you?',
    'phoneAppOnboarding.role.subhead': 'Pick your role to personalize your experience',
    'phoneAppOnboarding.role.parent.title': 'Parent',
    'phoneAppOnboarding.role.parent.sub': "Following my child's journey",
    'phoneAppOnboarding.role.student.title': 'Student',
    'phoneAppOnboarding.role.student.sub': 'Learning and growing',
    'phoneAppOnboarding.role.teacher.title': 'Teacher',
    'phoneAppOnboarding.role.teacher.sub': 'Guiding my students',
    'phoneAppOnboarding.role.soon': 'Soon',
    'phoneAppOnboarding.pain.headline': 'What matters most to you?',
    'phoneAppOnboarding.pain.subhead': 'Pick all that apply',
    'phoneAppOnboarding.pain.cta': 'Continue',
    'phoneAppOnboarding.biggest.headline': 'Which one bothers you the most?',
    'phoneAppOnboarding.biggest.subhead': "We'll start fixing this one first",
    'phoneAppOnboarding.biggest.cta': 'This is the one',
    'phoneAppOnboarding.aha.headline': 'A weekly summary, every Sunday',
    'phoneAppOnboarding.aha.subhead': 'Everything you need to know about your child in 60 seconds',
    'phoneAppOnboarding.aha.banner.title': 'String — Weekly Summary',
    'phoneAppOnboarding.aha.banner.body': "Sunday 7pm — Your child's weekly summary is ready",
    'phoneAppOnboarding.aha.topicLabel': 'Topic to ask about',
    'phoneAppOnboarding.aha.winLabel': 'Win to celebrate',
    'phoneAppOnboarding.aha.cta': 'Continue (coming soon)',
    'phoneAppOnboarding.aha.toast': 'The rest is on the way',
    'phoneAppOnboarding.back': 'Back',
    'phoneAppOnboarding.mute.on': 'Unmute',
    'phoneAppOnboarding.mute.off': 'Mute',
  },
};
